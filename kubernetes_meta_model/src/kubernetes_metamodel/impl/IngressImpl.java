 ...
 * </p>
 * <ul>
 *   <li>{@link kubernetes_metamodel.impl.IngressImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IngressImpl extends MinimalEObjectImpl.Container implements Ingress {
	...
	protected EClass eStaticClass() {
		return Kubernetes_metamodelPackage.Literals.INGRESS;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Kubernetes_metamodelPackage.INGRESS__PATH, oldPath, path));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Kubernetes_metamodelPackage.INGRESS__PATH:
				return getPath();
		}
