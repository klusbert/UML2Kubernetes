 ...
 * @generated
 */
public class Kubernetes_metamodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Kubernetes_metamodelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Kubernetes_metamodelPackage.INFRASTRUCTURE: {
				Infrastructure infrastructure = (Infrastructure)theEObject;
				T result = caseInfrastructure(infrastructure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Kubernetes_metamodelPackage.DEPLOYMENT: {
				Deployment deployment = (Deployment)theEObject;
				T result = caseDeployment(deployment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Kubernetes_metamodelPackage.ENVIROMENT_VARIABLES: {
				EnviromentVariables enviromentVariables = (EnviromentVariables)theEObject;
				T result = caseEnviromentVariables(enviromentVariables);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Kubernetes_metamodelPackage.DEPENDENCY: {
				Dependency dependency = (Dependency)theEObject;
				T result = caseDependency(dependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Kubernetes_metamodelPackage.VOLUME: {
				Volume volume = (Volume)theEObject;
				T result = caseVolume(volume);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Kubernetes_metamodelPackage.VOLUME_MOUNT: {
				VolumeMount volumeMount = (VolumeMount)theEObject;
				T result = caseVolumeMount(volumeMount);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Kubernetes_metamodelPackage.PERSISTENT_VOLUME_CLAIM: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Enviroment Variables</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Enviroment Variables</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
